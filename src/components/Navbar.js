    ...
    <>
      <div className="fixed flex flex-col w-full z-50">
        <div className="absolute w-full bg-black z-40 opacity-80 backdrop-blur-lg flex items-center justify-between h-[5rem] lg:justify-center lg:h-[6.2rem]">
          ...
          <a href='https://drive.google.com/file/d/1Wjj_G8Lh-gnQQIi565NaA9dT-nIXPhqv/view?usp=drive_link' target='_blank' className=''><motion.button className='hidden absolute text-white bg-transparent border-[3px] bottom-[1.65rem] border-[#ADFFFF] w-40 p-[0.4rem] right-10 text-xl rounded-lg font-semibold
        ...
        >
          <ul className="text-white pt-20">
            ...
            <li>
            <a href='https://drive.google.com/file/d/1D47FV9hKNmI9-iJ2RWowzctMTp8L8-lM/view?usp=drive_link' className=''><motion.button className='py-4 pl-8 w-full text-white border-y-[1px] border-[#ADFFFF] font-semibold bg-[#fcffff] bg-opacity-10 text-left
              lg:hidden
              ' 
                initial={{ opacity: 0, }}
                animate={{ opacity: 1, }}
